...
6. Les cartes sans résultat dans les sources gratuites sont **réexaminées automatiquement toutes les 24 heures**. Les erreurs réseau et quotas sont réessayés avec temporisation. L'état et l'index des URL sont sauvegardés sur la branche `pokevault-image-data` et dans les artifacts GitHub Actions.
